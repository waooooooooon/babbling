...
for p=[0.05]
  ...
  mkdir([outdir,'/p=',num2str(p),'_',yoked,'_',stdp]);
   ...
   for i=1:d
        %conduct babbling
           display(['firing_data/','p=',num2str(p),'_',yoked,'_',stdp,'/babble_daspnet_firings_',num2str(i),'_',id,'_',num2str(iterate),'_reinforce_100_4_',yoked,'_1_',num2str(feedbacktime),'_',num2str(p),'_',num2str(speinplate),'_',stdp,'_5000.txt']);
