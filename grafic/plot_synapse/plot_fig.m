%initialization
!rm -r ./synapse_strength_png
mkdir(['./synapse_strength_png']);
...
%load('./data_NSTDP/1_170222_1000_reinforce_100_4_Yoked_1_1_0_0.5_NSTDP_Workspace/babble_daspnet_reservoir_1_170222_1000_reinforce_100_4_Yoked_1_1_0_0.5_NSTDP.mat','s');  % load the value of s
load('./data/babble_daspnet_reservoir_1_170222_2000_reinforce_100_4_NY_1_1_0.05_0.5_NSTDP.mat','s');  % load the value of s
...
colorbar;
caxis([0,4]);
%title('Synapse Strength of NSTDP', 'fontweight','bold');
%xlabel('Synaptic index', 'fontweight','bold');
%ylabel('Neurons index', 'fontweight','bold');
saveas(fig1,['./synapse_strength_png/NSTDP.png']);
%%%%%%%%%%%%%
...
fig2.NumBins = 30;
fig2.BinEdges = [0:0.1:3];
fig2.FaceColor = 'k';
fig2.EdgeColor = 'k';
axis([0 3 0 50000]);
set(gca,'FontSize',16);
saveas(fig2,['./synapse_strength_png/hist_NSTDP.png']);
close all;
%%%%%%%%%%%%% end



%%%%%%%%%%%%% plot synapse strength of STDP
%load('./data_STDP/3_170222_1000_reinforce_100_4_NY_1_1_0.01_0.5_STDP_Workspace/babble_daspnet_reservoir_3_170222_1000_reinforce_100_4_NY_1_1_0.01_0.5_STDP.mat','s');  % load the value of s
load('./data/babble_daspnet_reservoir_1_170222_2000_reinforce_100_4_NY_1_1_0.05_0.5_STDP.mat','s');  % load the value of s
...
colorbar;
caxis([0,4]);
%title('Synapse Strength of STDP', 'fontweight','bold');?
%xlabel('Synaptic index', 'fontweight','bold');
%ylabel('Neurons index', 'fontweight','bold');

saveas(fig1,['./synapse_strength_png/STDP.png']);
%%%%%%%%%%%%%

%%%%%%%%%%%%% plot histogram of synaptic weights with STDP
fig2 = histogram(s(1:800,:));
fig2.NumBins = 30;
fig2.BinEdges = [0:0.1:3];
fig2.FaceColor = 'k';
...
set(gca,'FontSize',16);
ytickformat('%.2f');
saveas(fig2,['./synapse_strength_png/hist_STDP.png']);
close all;
%%%%%%%%%%%%% end